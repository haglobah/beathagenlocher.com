...
export const publishedKnowledge = await getCollection("knowledge", ({ data }) => data.publish);
export const draftKnowledge = await getCollection("knowledge", ({ data }) => !data.publish);
