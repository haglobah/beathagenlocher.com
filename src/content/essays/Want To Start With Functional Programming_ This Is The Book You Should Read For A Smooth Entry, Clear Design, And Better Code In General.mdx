...
updated: 2025-02-01
topics: [Reading, Functional Programming]
publish: true
---
...
For really capturing my attention, **the book moves too slow**.
...
In every chapter so far, it either changed my thinking or gave me new language/examples/mental models to talk and think about the issue(s) it describes.
