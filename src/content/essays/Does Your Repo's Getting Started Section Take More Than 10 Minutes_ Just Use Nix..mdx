...
updated: 2025-02-01
topics: [Nix, Simplicity, NixOS, Software Development]
publish: true
---
...
With a `devShell` from a [Nix Flake](https://zero-to-nix.com/concepts/flakes), we can get to this: 0. (You probably need to [install Nix](https://zero-to-nix.com/start/install) first: )
