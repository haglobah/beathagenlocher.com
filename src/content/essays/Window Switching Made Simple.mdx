...
topics: [Simplicity, Flow, GNOME, Automation]
publish: true
---
...
Addition (01/2026): Nowadays, I use [run-or-raise](https://github.com/CZ-NIC/run-or-raise) ([Github](https://github.com/CZ-NIC/run-or-raise)) with [this shortcuts.conf](https://github.com/haglobah/mynix/blob/51304fce35f897b9ae58785d500b885d271cbea5/home/dotfiles/shortcuts.conf#L20)

---

Addition (03/2026): As much as I've come to appreciate run-or-raise, its pretty hard to match browser windows in a semantically correct way. Here's what I'm doing now: [[Window Switching Made Simple | Part 2]]
