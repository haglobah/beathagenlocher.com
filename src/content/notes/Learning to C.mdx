...
Let's fix that and use an editor people actually use as their daily driver.
...
So far, you've only worked locally and on one state of your file system.
...
For all of this, one uses something called [[Version Control]].
