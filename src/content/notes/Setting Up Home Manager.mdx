...
The first thing our Home Manager [[Nix Flake]] needs is an _input_ to get packages from. We're probably going to use some packages, so we need [[nixpkgs]], and then we're going to use `home-manager`, too:
...
After it's done, close and reopen the terminal once. Then, do `which git` again—it should say something like this:
...
Before we go any further, it's time to give us some more safety while trying things out.
...
<References>
  <ReferenceLink href="https://nix-community.github.io/home-manager/index.xhtml">
    Home Manager Manual{' '}
  </ReferenceLink>
  <ReferenceLink href="https://nix-community.github.io/home-manager/index.xhtml#sec-flakes-standalone">
    Home Manager Manual Flakes Standalone Section{' '}
  </ReferenceLink>
  <ReferenceLink href="https://nix-community.github.io/home-manager/options.xhtml">
    Home Manager Configuration Options
  </ReferenceLink>
  <ReferenceLink href="https://www.youtube.com/watch?app=desktop&v=FcC2dzecovw" author="vimjoyer">
