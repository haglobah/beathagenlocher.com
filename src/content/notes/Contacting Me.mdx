...
- Best via text? -> [bah@posteo.de](mailto:bah@posteo.de)
- Best via call? -> [my calendar](https://calendar.app.google/khoGQJBfXMLq3xF87)
...
- If you think you can do that via a call, book one:  
  [Beat Hagenlocher's calendar](https://calendar.app.google/khoGQJBfXMLq3xF87)
...
1. Choose a slot: [https://calendar.app.google/khoGQJBfXMLq3xF87](https://calendar.app.google/khoGQJBfXMLq3xF87)
2. Add a description.
3. Have the call.
4. Done.
