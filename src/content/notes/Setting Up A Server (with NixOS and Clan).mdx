...
As with most things, setting up a server is relatively straightforward once you know what you're doing.
...
Since both the 'is reachable' and the 'runs constantly' parts are relatively hard to provide when you're just starting out (and probably only have a laptop/phone), you want to go to someone whose _job_ is to provide these two things (That's called a _Hosting Provider_).
