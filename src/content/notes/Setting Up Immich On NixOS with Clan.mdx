...
<Callout type="info">
  In case you don't know yet how to get and set up a server, take a look here: [[Setting Up A Server
  (with NixOS and Clan)]]
</Callout>
...
<References>
  <ReferenceLink href="https://forums.linuxmint.com/viewtopic.php?t=333084">
    Samba Storage Share{' '}
  </ReferenceLink>
</References>
