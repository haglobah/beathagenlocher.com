...
<References>
  <ReferenceLink href="https://github.com/haglobah/zmk-config-tzcl/blob/development/config/rae_dux.keymap">
    My layout
  </ReferenceLink>
  <ReferenceLink href="https://github.com/JustSamAgain/rae-dux-guide-and-config">
    A build guide
  </ReferenceLink>
</References>
