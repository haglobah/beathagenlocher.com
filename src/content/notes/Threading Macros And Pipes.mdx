...
A compiles is this:
`Source code -compiler-> Target Language Code (mostly Machine Code)`
...
When we apply this idea naively, this makes programs look like that:
