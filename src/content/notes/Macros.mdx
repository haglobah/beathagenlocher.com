...
They also have a second pretty helpful property: They use _the same syntax as the base language_.
...
This possibly couples the macro source code to the location it's being used in, which, if you squint, is the one unambiguously bad (default) feature in programming languages (again): [[Dynamic Scoping]]
