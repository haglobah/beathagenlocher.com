...
conferences:
  [
    {
      name: 'Tü-λ | Functional Programming Meetup Tübingen',
      date: '2025-01-15',
      location: 'itdesign',
    },
  ]
...
8. [[Machine Code]]
9. [[Assembly]]
10. [[Structured Programming]]/[[Procedural Programming]]
11. [[Object Oriented Programming|OOP]]
12. [[Functional Programming|FP]]?

13. [[Lambda Calculus]] and [[Turing Machine]]s: The two families of [[Programming Language]]s

14. Jump from [[Object Oriented Programming|OO]] to [[Functional Programming|FP]]: [[Behavior Data Time]]
15. Interpreting the [[History of Coupling]]: The complexity of our programs and systems rises, our working memory is constant, so it's really, really useful if the incidental complexity of our code _goes down_.

So, what _is_ [[Functional Programming]]? A style you can write programs in that has these characteristics/uses these features:
...
We say "It's like math", we call it "simple", but nothing of it really clicks. And we can see it.
